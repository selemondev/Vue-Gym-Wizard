...
import { ref } from "vue";
const neckExercises = ref([]);
const loading = ref(false);
const neckExercise = async () => {
    loading.value = true;
    const neckData = await useFetch("https://exercisedb.p.rapidapi.com/exercises/bodyPart/neck", exerciseOptions);
    neckExercises.value = neckData;
    loading.value = false;
}
neckExercise();
...
<main>
    ...
    <div class="grid place-items-center mt-4">
       ...
       <div class="flex justify-center items-center flex-wrap" v-else>
        <div v-for="exercise in neckExercises" :key="exercise.id" class="m-5">
