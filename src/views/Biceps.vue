...
const bicepsExercises = ref([]);
const loading = ref(false);
const bicepsExercise = async () => {
    loading.value = true
    const bicepsData = await useFetch("https://exercisedb.p.rapidapi.com/exercises/bodyPart/upper arms", exerciseOptions);
    bicepsExercises.value = bicepsData;
    loading.value = false;
}
bicepsExercise();
...
<main>
    ...
    <div class="grid place-items-center mt-4">
       ...
       <div class="flex justify-center items-center flex-wrap" v-else>
        <div v-for="exercise in bicepsExercises" :key="exercise.id" class="m-5">
