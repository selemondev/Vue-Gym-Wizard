...
const chestExercise = async () => {
    loading.value = true;
    const chestData = await useFetch("https://exercisedb.p.rapidapi.com/exercises/bodyPart/chest", exerciseOptions);
    chestExercises.value = chestData;
    loading.value = false;
}
chestExercise();
...
<main>
    ...
    <div class="grid place-items-center mt-4">
       ...
       <div class="flex justify-center items-center flex-wrap" v-else>
        <div v-for="exercise in chestExercises" :key="exercise.id" class="m-5">
