...
const legsExercises = ref([]);
const loading = ref(false);
const legsExercise = async () => {
    loading.value = true;
    const legsData = await useFetch("https://exercisedb.p.rapidapi.com/exercises/bodyPart/upper legs", exerciseOptions);
    legsExercises.value = legsData;
    loading.value = false;
}
legsExercise();
...
<main>
    ...
    <div class="grid place-items-center mt-4">
       ...
       <div class="flex justify-center items-center flex-wrap" v-else>
        <div v-for="exercise in legsExercises" :key="exercise.id" class="m-5">
