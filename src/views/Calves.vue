...
const calvesExercises = ref([]);
const loading = ref(false);
const calvesExercise = async () => {
    loading.value = true;
    const calvesData = await useFetch("https://exercisedb.p.rapidapi.com/exercises/bodyPart/lower legs", exerciseOptions);
    calvesExercises.value = calvesData;
    loading.value = false;
}
calvesExercise();
...
<main>
    ...
    <div class="grid place-items-center mt-4">
       ...
       <div class="flex justify-center items-center flex-wrap" v-else>
        <div v-for="exercise in calvesExercises" :key="exercise.id" class="m-5">
